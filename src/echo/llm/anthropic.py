                    ...
                    for event in stream:
                        if event.type == "content_block_start":
                            ...
                            if delta.type == "text_delta":
                                ...
                                # Forward the partial json fragment as a
                                # streaming TOOL_CALL_ARGS event so AG-UI
                                # consumers can render args as they arrive.
                                # Skip for elicitation tools, mirroring the
                                # TOOL_CALL_START / TOOL_CALL_END skip below.
